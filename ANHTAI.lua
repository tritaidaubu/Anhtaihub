...
local MainTab = XSeaGui:MakeTab("Main")
...
local Tabs = {
    info = Window:AddTab({ Title = "Info", Icon = "cherry" }),
    ...
    Shop = Window:AddTab({ Title = "Cửa Hàng", Icon = "cherry" }),
	Misc = Window:AddTab({ Title = "Misc", Icon = "cherry" }),
    Hop = Window:AddTab({ Title = "Hop", Icon = "cherry" }),
}
...
local boss = Tabs.Main:AddSection("Boss Farm")
    ...
    if First_Sea then
        MaterialList = {
          "Sắt Vụng","Da Thuột","Cách Thiên Thần","Quặng Nham Thạch","Fish Tail"
        } elseif Second_Sea then
        MaterialList = {
          "Sắt Vụng","Da","Radioactive Phóng Sạ","Nướt Mắt Thần Bí","Quặng Nham Thạch","Răng Nanh"
        } elseif Third_Sea then
        MaterialList = {
          "Sắt Vụng","Quỷ Hồn","Bột Cacao","Vẫy Rồng","Thuốc Súng","Sừng Tê Giác"
        }
        end
    ...
    DropdownMaterial:SetValue("Vẫy Rồng")
...
function UpdateKitsune()
    if game.Workspace._WorldOrigin.Locations:FindFirstChild('Kitsune Island') then
        StatusKitsune:SetDesc("Đảo Kitsune : 🟢yes")
    else
        StatusKitsune:SetDesc("Đảo Kitsune : 🔴no")
     end
end
spawn(function()
    pcall(function()
      ...
      local ToggleEspKitsune = Tabs.Main:AddToggle("ToggleEspKitsune", {Title = "Esp Định vị Kitsune Island",Description = "Định vị Đảo kisune", Default = false })
