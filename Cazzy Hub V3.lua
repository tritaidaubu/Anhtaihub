...
local main = Library.Zee({Title = "Zee Hub [Mobile/PC]                  YouTube: anhtai",
    Logo = 11904908797,
...
assert(getrawmetatable)
    ...
    grm.__namecall = newcclosure(function(self, ...)
        local args = {...}
        elseif tostring(args[1]) == "Cut the woods" then
            return
...
FastAttack = {"Slow","Fast","Extreme (Risk)",}
Main:Dropdown("Fast Attack Speed", FastAttack, function(value)
...
Shop:Button("Buy Selected Abilities", function()
...
Shop:Button("Buy Selected Melee", function()
...
Shop:Button("Buy Selected Sword", function()
