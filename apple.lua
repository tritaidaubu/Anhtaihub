...
ImageButton1.Image = "rbxassetid://18737910294"
...
if game:GetService("CoreGui"):FindFirstChild("Ak Hub") then
    game:GetService("CoreGui"):FindFirstChild("Ak Hub"):Destroy()
end
...
local Library = Update:Window("AK HUB","",Enum.KeyCode.RightControl);
...
NguyenTien:AddLabel("Ui: Tri Minh Hub")
NguyenTien:AddLabel("Nhận Cho Thuê Script by ! Béo Biên Hòa!")

NguyenTien:AddSeperator("Social Network")
NguyenTien:AddButton("Facebook Official",function()
setclipboard("https://www.facebook.com/profile.php?id=100046519066971&mibextid=ZbWKwL")
Notif.New("Copying To Clipboard DoneðŸŽ‰", 3)
end)
NguyenTien:AddButton("YouTube Official",function()
setclipboard("https://m.youtube.com/@akgamingytb999")
Notif.New("Copying To Clipboard DoneðŸŽ‰", 3)
end)
NguyenTien:AddButton("Tik Tok Official Owner",function()
setclipboard("https://www.tiktok.com/@akgamingfunny?_t=8oU0yIQVl7o&_r=1")
Notif.New("Copying To Clipboard DoneðŸŽ‰", 3)
end)
---- Trang Chá»§
