...
local AlchemyNotify = function(Text_i,Duration_i)
    game.StarterGui:SetCore("SendNotification", {
        ...
        Text = Text_i,
        Duration = Duration_i,
        Icon = "rbxassetid://17094709022"
    })
end
--Key
wait(0.1)
AlchemyNotify("Thanks for using DEVELOP ! JACK Hub!",5)
wait(0.1)
AlchemyNotify("discord.com/invite/mA4DJmay",5)
wait(0.5)
local Notification = require(game:GetService("ReplicatedStorage").Notification)
Notification.new("<Color=Cyan> OXYGEN Hub V2Script<Color=/>"):Display()
wait(0.5)
...
local a = a:Window("Free Version | Blox Fruit")
...
HomePage:Button("Copy Discord Link", function()
    ...
    setclipboard("https://discord.com/invite/mA4DJmay")
end)
-----------------------------------------------------------------------------------------------------------------------------Function
...
Main:Toggle("Auto Random Surprise", false, function(value)
                        ...
                        if v.Name == "Terrorshark" then
                            if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                repeat task.wait()
                                    ...
                                    game:GetService("VirtualUser"):CaptureController()
                                    game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                until not  _G.AutoTerrorshark or noit v.Parent or v.Humanoid.Health <= 0
                                Min_XT_Is_Kak = false
                            end
                        end
                    end
...
Event:Seperator("ESP")
Event:Toggle("ESP Mirage",true, function(value)
